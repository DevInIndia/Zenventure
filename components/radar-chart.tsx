...
//   const [userLevel, setUserLevel] = useState<"Novice" | "Adept" | "Master">("Novice");

//   const legendData = [
//     { name: "Novice", color: "#FF6B6B", value: "0-40" },
//     { name: "Adept", color: "#06D6A0", value: "41-70" },
//     { name: "Master", color: "#9381FF", value: "71-100" },
//   ];
...
//     const currentStreak = 1; // temporary fallback
//     if (totalStats > 0) {
//       const consistencyScore =
//         (Math.min(stats.mindful, stats.productive, stats.fit) /
//           Math.max(stats.mindful, stats.productive, stats.fit)) ||
//         0;
//       calculatedDiscipline = Math.min(100, Math.round(currentStreak * 5 + consistencyScore * 50));
//     }

//     // Calculate overall average to decide the level
//     const statArray = [
//       stats.mindful,
//       stats.productive,
//       stats.fit,
...
//       calculatedBalanced,
//     ];
//     const averageStat = statArray.reduce((sum, val) => sum + val, 0) / statArray.length;
...
//         <h3 className="text-[#f9c80e] text-base mb-4 font-bold tracking-wide">
//           YOUR LEVEL: <span className="text-[#dbd8e3]">{userLevel}</span>
//         </h3>
